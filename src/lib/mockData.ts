...
export const FILM_SPLIT = [
  { role: 'Producers', pct: 0.35, accent: 'cyan' as const },
  { role: 'Directors', pct: 0.2, accent: 'gold' as const },
  { role: 'Audio Designers', pct: 0.15, accent: 'emerald' as const },
  { role: 'State Tax Treasury', pct: 0.1, accent: 'gold' as const },
  { role: 'Federal Tax Treasury', pct: 0.2, accent: 'cyan' as const },
]
