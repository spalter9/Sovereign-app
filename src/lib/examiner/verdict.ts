 ...
 * 80% balanced accuracy — real signal, but nowhere near proof, and it fell as
...
export function combineVerdict(
  ...
  caveats.push(
    `The recording reading is a screening signal, not proof: three measurements combined, ~80% accurate held out over 36 tracks of known provenance, and weaker on unfamiliar material. It abstains when unsure${
