        ...
        return (
          <button
            ...
            className={[
              ...
              'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-signal/60',
              selected
                ? 'glow-ring border-cyan-signal/45 bg-cyan-signal/10 text-cyan-signal'
                : 'border-border-subtle bg-void-elevated/50 text-text-muted hover:border-cyan-signal/30 hover:text-text-primary',
            ].join(' ')}
          >
